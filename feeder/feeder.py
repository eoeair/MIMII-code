...
class BaseFeeder(torch.utils.data.Dataset):
    """ Base Feeder for label inputs """
...
class Feeder_snr(BaseFeeder):
    """ Feeder for snr inputs """
    pass


class Feeder_device(BaseFeeder):
    """ Feeder for device inputs """
    pass


class Feeder_label(BaseFeeder):
